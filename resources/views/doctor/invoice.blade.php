                ...
                <div class="mt-4">
                    ...
                    <div class="text-95 text-secondary-d3">
                        ...
                        <div class="row mb-2 mb-sm-0 py-25">
                            ...
                            <div class="col-9 col-sm-3">{{$treatment_info->treatment_plans."/".$treatment_info->tooth_no}}</div>
                    ...
                    <div class="row   mt-3">
                        ...
                        <div class="col-3 col-sm-3 text-end text-grey text-90 order-first order-sm-last pt-3 mx-auto">
                            ...
                            <div class="border-bottom">
                                @if($today_paid != null)
                                @foreach($today_paid as $t_paid)
                                <p class="me-3">
                                    {{$t_paid->treat->treatment_plans." (".$t_paid->treat->tooth_no.")"}}
                                    <span class="ms-4">
                                        @php
                        ...
                        <div class="col-5 col-sm-5 text-grey text-90 order-first order-sm-last align-self-end">
                            ...
                            <div class="row mx-0 my-2 fw-bold">
                                <div class="col-8 text-end">
                                    Discount
                                    @if($discount == null)
                                    @elseif($discount->discount_type == "precent")
                                    ({{$discount->discount}}%)
                                    @else
                                    (৳ {{$discount->discount}})
                                    @endif
                            ...
                            <div class="row mx-0 my-2 fw-bold align-items-center bgc-primary-l3 ">
                                ...
                                <div class="col-4 text-end">
                                    <span class="text-150 text-success-d3 opacity-2">{{$total_paid}}</span>
                                </div>
                            </div>
                            ...
                            <div class="row mx-0 my-2 fw-bold align-items-center bgc-primary-l3 ">
                                ...
                                <div class="col-4 text-end">
                                    <span class="text-150 text-success-d3 opacity-2">{{$total_dueAmount}}</span>
                                </div>
                            </div>
                ...
                <form action="{{route('treatment_payment')}}" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" aria-label="Default select example" name="t_plan_id" id="t_plan_id">
                            ...
                            <option value="{{$treatment_invoice_info -> id}}">{{$treatment_invoice_info -> treatment_plans}}-{{$treatment_invoice_info -> tooth_no}}</option>
                            @endforeach
                        </select>
                        <span class="text-danger">@error('t_plan_id') {{$message}} @enderror</span>
                    </div>
                    <div class="mb-3">
                        ...
                        <span class="text-danger">@error('t_payment_type') {{$message}} @enderror</span>
                    </div>
                    <div class="mb-3">
                        <input type="number" class="form-control" list="list" placeholder="Enter Amount" name="tp_amount">
                        <span class="text-danger">@error('tp_amount') {{$message}} @enderror</span>
                    </div>

                    <div class="form-check">
                        <input type="checkbox" class="form-check-input active" name="billing_sms" id="registration_sms" value="on">
                        <label class="form-check-label" for="billing_sms">Send SMS to Patient?</label>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('treatment_discount')}}" method="post">
                    ...
                    <div class="mb-3">
                        <input type="text" class="form-control" list="list" name="p_mobile" value="{{$patient->mobile}}" readonly>
                    </div>
                    <div class="mb-3">
                    ...
                    <span class="text-danger">@error('t_discount_type') {{$message}} @enderror</span>
                    <div class="mb-3">
                        <input type="number" class="form-control" list="list" placeholder="Enter Discount" name="tp_discount">
                        <span class="text-danger">@error('tp_discount') {{$message}} @enderror</span>
                    </div>
...
<script>
    $(document).ready(function() {
        @if(Session::has('invalidPaymentAdd') && count($errors) > 0)
        $('#Treatment_Payment').modal('show');
        @endif
        @if(Session::has('invalidDiscountAdd') && count($errors) > 0)
