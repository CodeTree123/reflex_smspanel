        ...
        <div class="col-md-7 pe-0">
            <div class="blank-sec">
                                    ...
                                    <div class="upper-right T-border-bottom">
                                        ...
                                        <div class="upper-right-teeths">
                                            <ul>
                                                <li>
                                                    <!-- <p>1</p> -->
                                                    <img src="{{ asset('assets/img/teeths/Upper-right/1TMR.png')}}" alt="" id="18" class="tooth_click">
                                                    <p class="mb-0">18</p>
                                                    <input type="checkbox" id="t" name="t" value="18" style="display:none" class="select t">
                                                </li>
                                                <li>
                                                    <!-- <p>2</p> -->
                                                    <img src="{{ asset('assets/img/teeths/Upper-right/2SMR.png')}}" alt="" id="17" class="tooth_click">
                                                    <p class="mb-0">17</p>
                                                    <input type="checkbox" id="t" name="t" value="17" style="display:none" class="select t">
                                                </li>
                                                <li>
                                                    <!-- <p>3</p> -->
                                                    <img src="{{ asset('assets/img/teeths/Upper-right/3FMR.png')}}" alt="" id="16" class="tooth_click">
                                                    <p class="mb-0">16</p>
                                                    <input type="checkbox" id="t" name="t" value="16" style="display:none" class="select t">
                                                </li>
                                                <li>
                                                    <!-- <p>4</p> -->
                                                    <img src="{{ asset('assets/img/teeths/Upper-right/4SPMR.png')}}" alt="" id="15" class="tooth_click">
                                                    <p class="mb-0">15</p>
                                                    <input type="checkbox" id="t" name="t" value="15" style="display:none" class="select t">
                                                </li>
                                                <li>
                                                    <!-- <p>5</p> -->
                                                    <img src="{{ asset('assets/img/teeths/Upper-right/5FPMR.png')}}" alt="" id="14" class="tooth_click">
                                                    <p class="mb-0">14</p>
                                                    <input type="checkbox" id="t" name="t" value="14" style="display:none" class="select t">
                                                </li>
                                                <li>
                                                    <!-- <p>6</p> -->
                                                    <img src="{{ asset('assets/img/teeths/Upper-right/6CR.png')}}" alt="" id="13" class="tooth_click">
                                                    <p class="mb-0">13</p>
                                                    <input type="checkbox" id="t" name="t" value="13" style="display:none" class="select t">
                                                </li>
                                                <li>
                                                    <!-- <p>7</p> -->
                                                    <img src="{{ asset('assets/img/teeths/Upper-right/7LIR.png')}}" alt="" id="12" class="tooth_click">
                                                    <p class="mb-0">12</p>
                                                    <input type="checkbox" id="t" name="t" value="12" style="display:none" class="select t">
                                                </li>
                                                <li>
                                                    <!-- <p>8</p> -->
                                                    <img src="{{ asset('assets/img/teeths/Upper-right/8CIR.png')}}" alt="" id="11" class="tooth_click">
                                                    <p class="mb-0">11</p>
                                    ...
                                    <div class="upper-right T-border-bottom">
                                        ...
                                        <div class="upper-right-teeths">
                                            <ul>
                                                <li>
                                                    <!-- <p>9</p> -->
                                                    <img src="{{ asset('assets/img/teeths/Upper-left/9CIL.png')}}" alt="" id="21" class="tooth_click">
                                                    <p class="mb-0">21</p>
                                                    <input type="checkbox" id="t" name="t" value="21" style="display:none" class="select t">
                                                </li>
                                                <li>
                                                    <!-- <p>10</p> -->
                                                    <img src="{{ asset('assets/img/teeths/Upper-left/10LIL.png')}}" alt="" id="22" class="tooth_click">
                                                    <p class="mb-0">22</p>
                                                    <input type="checkbox" id="t" name="t" value="22" style="display:none" class="select t">
                                                </li>
                                                <li>
                                                    <!-- <p>11</p> -->
                                                    <img src="{{ asset('assets/img/teeths/Upper-left/11CL.png')}}" alt="" id="23" class="tooth_click">
                                                    <p class="mb-0">23</p>
                                                    <input type="checkbox" id="t" name="t" value="23" style="display:none" class="select t">
                                                </li>
                                                <li>
                                                    <!-- <p>12</p> -->
                                                    <img src="{{ asset('assets/img/teeths/Upper-left/12FPML.png')}}" alt="" id="24" class="tooth_click">
                                                    <p class="mb-0">24</p>
                                                    <input type="checkbox" id="t" name="t" value="24" style="display:none" class="select t">
                                                </li>
                                                <li>
                                                    <!-- <p>13</p> -->
                                                    <img src="{{ asset('assets/img/teeths/Upper-left/13SPML.png')}}" alt="" id="25" class="tooth_click">
                                                    <p class="mb-0">25</p>
                                                    <input type="checkbox" id="t" name="t" value="25" style="display:none" class="select t">
                                                </li>
                                                <li>
                                                    <!-- <p>14</p> -->
                                                    <img src="{{ asset('assets/img/teeths/Upper-left/14FML.png')}}" alt="" id="26" class="tooth_click">
                                                    <p class="mb-0">26</p>
                                                    <input type="checkbox" id="t" name="t" value="26" style="display:none" class="select t">
                                                </li>
                                                <li>
                                                    <!-- <p>15</p> -->
                                                    <img src="{{ asset('assets/img/teeths/Upper-left/15SML.png')}}" alt="" id="27" class="tooth_click">
                                                    <p class="mb-0">27</p>
                                                    <input type="checkbox" id="t" name="t" value="27" style="display:none" class="select t">
                                                </li>
                                                <li>
                                                    <!-- <p>16</p> -->
                                                    <img src="{{ asset('assets/img/teeths/Upper-left/16TML.png')}}" alt="" id="28" class="tooth_click">
                                                    <p class="mb-0">28</p>
                                        ...
                                        <div class="upper-right-teeths">
                                            <ul>
                                                <li>
                                                    ...
                                                    <p class="mb-0">48</p>
                                                    <img src="{{ asset('assets/img/teeths/Lower-Right/48TMR.png')}}" alt="" id="48" class="tooth_click">
                                                    <!-- <p>32</p> -->
                                                </li>
                                                <li>
                                                    <input type="checkbox" id="t" name="t" value="47" style="display:none" class="select t">
                                                    <p class="mb-0">47</p>
                                                    <img src="{{ asset('assets/img/teeths/Lower-Right/47SMR.png')}}" alt="" id="47" class="tooth_click">
                                                    <!-- <p>31</p> -->
                                                </li>
                                                <li>
                                                    <input type="checkbox" id="t" name="t" value="46" style="display:none" class="select t">
                                                    <p class="mb-0">46</p>
                                                    <img src="{{ asset('assets/img/teeths/Lower-Right/46FMR.png')}}" alt="" id="46" class="tooth_click">
                                                    <!-- <p>30</p> -->
                                                </li>
                                                <li>
                                                    <input type="checkbox" id="t" name="t" value="46" style="display:none" class="select t">
                                                    <p class="mb-0">45</p>
                                                    <img src="{{ asset('assets/img/teeths/Lower-Right/45SPMR.png')}}" alt="" id="45" class="tooth_click">
                                                    <!-- <p>29</p> -->
                                                </li>
                                                <li>
                                                    <input type="checkbox" id="t" name="t" value="44" style="display:none" class="select t">
                                                    <p class="mb-0">44</p>
                                                    <img src="{{ asset('assets/img/teeths/Lower-Right/44FPMR.png')}}" alt="" id="44" class="tooth_click">
                                                    <!-- <p>28</p> -->
                                                </li>
                                                <li>
                                                    <input type="checkbox" id="t" name="t" value="43" style="display:none" class="select t">
                                                    <p class="mb-0">43</p>
                                                    <img src="{{ asset('assets/img/teeths/Lower-Right/43CR.png')}}" alt="" id="43" class="tooth_click">
                                                    <!-- <p>27</p> -->
                                                </li>
                                                <li>
                                                    <input type="checkbox" id="t" name="t" value="42" style="display:none" class="select t">
                                                    <p class="mb-0">42</p>
                                                    <img src="{{ asset('assets/img/teeths/Lower-Right/42LIR.png')}}" alt="" id="42" class="tooth_click">
                                                    <!-- <p>26</p> -->
                                                </li>
                                                <li>
                                                    <input type="checkbox" id="t" name="t" value="41" style="display:none" class="select t">
                                                    <p class="mb-0">41</p>
                                                    <img src="{{ asset('assets/img/teeths/Lower-Right/41CIR.png')}}" alt="" id="41" class="tooth_click">
                                                    <!-- <p>25</p> -->
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <div class="upper-right-teeths">
                                            <ul>
                                                <li>
                                                    ...
                                                    <p class="mb-0">31</p>
                                                    <img src="{{ asset('assets/img/teeths/Lower-Left/31CIL.png')}}" alt="" id="31" class="tooth_click">
                                                    <!-- <p>24</p> -->
                                                </li>
                                                <li>
                                                    <input type="checkbox" id="t" name="t" value="32" style="display:none" class="select t">
                                                    <p class="mb-0">32</p>
                                                    <img src="{{ asset('assets/img/teeths/Lower-Left/32LIL.png')}}" alt="" id="32" class="tooth_click">
                                                    <!-- <p>23</p> -->
                                                </li>
                                                <li>
                                                    <input type="checkbox" id="t" name="t" value="33" style="display:none" class="select t">
                                                    <p class="mb-0">33</p>
                                                    <img src="{{ asset('assets/img/teeths/Lower-Left/33CL.png')}}" alt="" id="33" class="tooth_click">
                                                    <!-- <p>22</p> -->
                                                </li>
                                                <li>
                                                    <input type="checkbox" id="t" name="t" value="34" style="display:none" class="select t">
                                                    <p class="mb-0">34</p>
                                                    <img src="{{ asset('assets/img/teeths/Lower-Left/34FPML.png')}}" alt="" id="34" class="tooth_click">
                                                    <!-- <p>21</p> -->
                                                </li>
                                                <li>
                                                    <input type="checkbox" id="t" name="t" value="35" style="display:none" class="select t">
                                                    <p class="mb-0">35</p>
                                                    <img src="{{ asset('assets/img/teeths/Lower-Left/35SPML.png')}}" alt="" id="35" class="tooth_click">
                                                    <!-- <p>20</p> -->
                                                </li>
                                                <li>
                                                    <input type="checkbox" id="t" name="t" value="36" style="display:none" class="select t">
                                                    <p class="mb-0">36</p>
                                                    <img src="{{ asset('assets/img/teeths/Lower-Left/36FML.png')}}" alt="" id="36" class="tooth_click">
                                                    <!-- <p>19</p> -->
                                                </li>
                                                <li>
                                                    <input type="checkbox" id="t" name="t" value="37" style="display:none" class="select t">
                                                    <p class="mb-0">37</p>
                                                    <img src="{{ asset('assets/img/teeths/Lower-Left/37SML.png')}}" alt="" id="37" class="tooth_click">
                                                    <!-- <p>18</p> -->
                                                </li>
                                                <li>
                                                    <input type="checkbox" id="t" name="t" value="38" style="display:none" class="select t">
                                                    <p class="mb-0">38</p>
                                                    <img src="{{ asset('assets/img/teeths/Lower-Left/38TML.png')}}" alt="" id="38" class="tooth_click">
                                                    <!-- <p>17</p> -->
                                                </li>
                                            </ul>
                                        </div>
                                ...
                                <div class="col-md-6 p-0 T-border-right">
                                    <div class="upper-right T-border-bottom">
                                        ...
                                        <div class="upper-right-teeths">
                                            <ul>
                                                <li>
                                                    <img src="{{ asset('assets/img/teeths/Upper-right/4SPMR.png')}}" alt="" id="55" class="tooth_click">
                                                    <p class="mb-0">55</p>
                                                ...
                                                <li>
                                                    <img src="{{ asset('assets/img/teeths/Upper-right/5FPMR.png')}}" alt="" id="54" class="tooth_click">
                                                    <p class="mb-0">54</p>
                                                ...
                                                <li>
                                                    <img src="{{ asset('assets/img/teeths/Upper-right/6CR.png')}}" alt="" id="53" class="tooth_click">
                                                    <p class="mb-0">53</p>
                                                ...
                                                <li>
                                                    <img src="{{ asset('assets/img/teeths/Upper-right/7LIR.png')}}" alt="" id="52" class="tooth_click">
                                                    <p class="mb-0">52</p>
                                                ...
                                                <li>
                                                    <img src="{{ asset('assets/img/teeths/Upper-right/8CIR.png')}}" alt="" id="51" class="tooth_click">
                                                    <p class="mb-0">51</p>
                                ...
                                <div class="col-md-6 p-0 T-border-left">
                                    <div class="upper-right T-border-bottom">
                                        ...
                                        <div class="upper-right-teeths">
                                            <ul>
                                                <li>
                                                    <img src="{{ asset('assets/img/teeths/Upper-left/9CIL.png')}}" alt="" id="61" class="tooth_click">
                                                    <p class="mb-0">61</p>
                                                ...
                                                <li>
                                                    <img src="{{ asset('assets/img/teeths/Upper-left/10LIL.png')}}" alt="" id="62" class="tooth_click">
                                                    <p class="mb-0">62</p>
                                                ...
                                                <li>
                                                    <img src="{{ asset('assets/img/teeths/Upper-left/11CL.png')}}" alt="" id="63" class="tooth_click">
                                                    <p class="mb-0">63</p>
                                                ...
                                                <li>
                                                    <img src="{{ asset('assets/img/teeths/Upper-left/12FPML.png')}}" alt="" id="64" class="tooth_click">
                                                    <p class="mb-0">64</p>
                                                ...
                                                <li>
                                                    <img src="{{ asset('assets/img/teeths/Upper-left/13SPML.png')}}" alt="" id="65" class="tooth_click">
                                                    <p class="mb-0">65</p>
                                        ...
                                        <div class="upper-right-teeths mb-3">
                                            <ul>
                                                <li>
                                                    ...
                                                    <p class="mb-0">85</p>
                                                    <img src="{{ asset('assets/img/teeths/Lower-Right/45SPMR.png')}}" alt="" id="85" class="tooth_click">
                                                </li>
                                                <li>
                                                    <!-- <p>44</p> -->
                                                    <!--<p>S</p>-->
                                                    ...
                                                    <p class="mb-0">84</p>
                                                    <img src="{{ asset('assets/img/teeths/Lower-Right/44FPMR.png')}}" alt="" id="84" class="tooth_click">
                                                </li>
                                                <li>
                                                    <!-- <p>43</p> -->
                                                    <!--<p>R</p>-->
                                                    ...
                                                    <p class="mb-0">83</p>
                                                    <img src="{{ asset('assets/img/teeths/Lower-Right/43CR.png')}}" alt="" id="83" class="tooth_click">
                                                </li>
                                                <li>
                                                    <!-- <p>42</p> -->
                                                    <!--<p>Q</p>-->
                                                    ...
                                                    <p class="mb-0">82</p>
                                                    <img src="{{ asset('assets/img/teeths/Lower-Right/42LIR.png')}}" alt="" id="82" class="tooth_click">
                                                </li>
                                                <li>
                                                    <!-- <p>41</p> -->
                                                    <!--<p>P</p>-->
                                                    ...
                                                    <p class="mb-0">81</p>
                                                    <img src="{{ asset('assets/img/teeths/Lower-Right/41CIR.png')}}" alt="" id="81" class="tooth_click">
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <div class="upper-right-teeths">
                                            <ul>
                                                <li>
                                                    ...
                                                    <p class="mb-0">71</p>
                                                    <img src="{{ asset('assets/img/teeths/Lower-Left/31CIL.png')}}" alt="" id="71" class="tooth_click">
                                                </li>
                                                <li>
                                                    <!-- <p>32</p> -->
                                                    <!--<p>N</p>-->
                                                    ...
                                                    <p class="mb-0">72</p>
                                                    <img src="{{ asset('assets/img/teeths/Lower-Left/32LIL.png')}}" alt="" id="72" class="tooth_click">
                                                </li>
                                                <li>
                                                    <!-- <p>33</p> -->
                                                    <!--<p>M</p>-->
                                                    ...
                                                    <p class="mb-0">73</p>
                                                    <img src="{{ asset('assets/img/teeths/Lower-Left/33CL.png')}}" alt="" id="73" class="tooth_click">
                                                </li>
                                                <li>
                                                    <!-- <p>34</p> -->
                                                    <!--<p>L</p>-->
                                                    ...
                                                    <p class="mb-0">74</p>
                                                    <img src="{{ asset('assets/img/teeths/Lower-Left/34FPML.png')}}" alt="" id="74" class="tooth_click">
                                                </li>
                                                <li>
                                                    <!-- <p>35</p> -->
                                                    <!--<p>K</p>-->
                                                    ...
                                                    <p class="mb-0">75</p>
                                                    <img src="{{ asset('assets/img/teeths/Lower-Left/35SPML.png')}}" alt="" id="75" class="tooth_click">
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                ...
                <div class="treatment-cards my-3">
                    ...
                    <div class="row mx-2">
                        @forelse($treatment_infos as $treatment_info)
                        <div class="col-md-4 p-0 pt-3 pe-1">
                            <div class="treatment-card d-flex flex-column flex-wrap">
                                ...
                                <div class="treatment-card-btn d-flex {{$treatment_info->status == 0 ? 'justify-content-between' : 'justify-content-center'}}">

                                    <button type="button" class="btn btn-sm treat_edit {{$treatment_info->status == 0}}" value="{{$treatment_info->id}}">
                                    ...
                                    <button type="button" class="btn btn-sm delete-tp_info {{$treatment_info->status == 0 ? '' : 'd-none'}}" value="{{$treatment_info->id}}" data-tp_info-tooth="{{$treatment_info->tooth_no}}">
...
@include('doctor.include.modals.view_patient_modals')
...
<script>
    $(document).ready(function() {
        ...
        @if(Session::has('invalidTreatAdd') && count($errors) > 0)
        let tooth_num = {
            {
        ...
        $(document).on('click', '.treat_edit', function(e) {
            let t_id = $(this).val();
            let url = "{{route('treatment_info_edit',[':t_id'])}}";
        ...
        $(document).on('click', '.CC_editbtn', function() {
            var cc_id = $(this).val();
            let url = "{{route('edit_chife_complaint',[':cc_id'])}}";
        ...
        $(document).on('click', '.CF_editbtn', function() {
            var cf_id = $(this).val();
            let url = "{{route('edit_clinical_finding',[':cf_id'])}}";
        ...
        $(document).on('click', '.Investigation_editbtn', function() {
            ...
            let url = "{{route('edit_investigation',[':Investigation_id'])}}";
        ...
        $(document).on('click', '.TP_editbtn', function() {
            var tp_id = $(this).val();
            let url = "{{route('edit_treatment_plan',[':tp_id'])}}";
        ...
        @if(Session::has('invalidPatientUpdate') && count($errors) > 0)
