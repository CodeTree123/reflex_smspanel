    ...
    <div class="row">
        ...
        <div class="col-md-7 pe-0">
            <div class="blank-sec">
                ...
                <div class="mt-2">
                    <form action="{{route('patient_list',$doctor_info->id)}}" method="get" id="patient_search">
                <div class="input-group search_patient">
                    <input type="text" class="form-control" aria-label="Search By Name or Phone" id="s_patient" name="s_patient" placeholder="Search By Name or Phone." value="{{request()->get('s_patient')}}">
                    <span class="input-group-text">
                        <button type="submit" class="btn p-0" id="search_p">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="d-flex justify-content-around">
                            <!-- <button type="button" class="btn crud-btns Patient_viewbtn" value="{{$patient->id}}">
                                <i class="fa-solid fa-file-lines"></i>
                            </button> -->
                            <div class="dropdown dropstart">
                                <button type="button" class="btn crud-btns" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false" value="{{$patient->id}}">
                                    <i class="fa-solid fa-file-lines"></i>
                                </button>
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <li>
                                        <button type="button" class="dropdown-item Patient_viewbtn" value="{{$patient->id}}">
                                            View Patient
                                        </button>
                                    </li>
                                    <li><a class="dropdown-item" href="{{route('view_patient',[$doctor_info->id,$patient->id])}}">Open Profile</a></li>
                                </ul>
                            </div>
                            <button type="button" class="btn crud-btns Patient_editbtn {{"P_".$patient->id}}" value="{{$patient->id}}">
                                <i class="fa-solid fa-pen-to-square"></i>
                            </button>
                            <button class="btn crud-btns delete-patient" data-pl-name="{{$patient->name}}" value="{{$patient->id}}">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('update_patient_list')}}" method="POST" enctype="multipart/form-data" id="UpdatePatientFromList">
                    @csrf
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.Patient_viewbtn', function() {
            ...
            // alert(Patient_id);
            var url = "{{route('edit_patient_list',[':Patient_id'])}}";
