...
<div class="header  mb-3 shadow">
    <div class="container-fluid pt-2">
        <div class="row align-items-center">
            ...
            @if(auth()->user())
                @if(Route::current()->getName() != 'login_profile_edit')
                    <div class="col-md-4">
                            ...
                            <div class="container-fluid">
                                <div class="collapse navbar-collapse" id="navbarNav">
                                    <ul class="navbar-nav fs-5 pe-auto">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link text-bg-blue-grey" href="{{route('shop')}}" target="_blank">Shop</a>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link text-bg-blue-grey" href="{{route('forum')}}" target="_blank">Forum</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
