        ...
        <div class="row align-items-center p-3">
            <div class="col-12 mb-auto">
                ...
                <div class="row align-items-center">
                    <div class="col-12">
                        <div class="row ">
                            <div class="col-3 d-flex {{$post->post_type == 4 ? 'justify-content-evenly':'justify-content-center'}} align-items-center p-2">
                                @if($post->post_type == 4)
                                @php
                                ...
                                <img src="{{asset('public/uploads/report/'.$report->image)}}" alt="" width="80px" height="80px">
                                @endforeach
