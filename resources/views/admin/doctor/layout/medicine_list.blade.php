        ...
        @foreach($medicines_lists as $key=>$medicines_list)
            <tr>
                ...
                <td class="d-flex justify-content-around p-0">
                    <button type="button" class="btn crud-btns Medicine_editbtn {{"med_".$medicines_list->id}}"
                            value="{{$medicines_list->id}}">
                        <i class="fa-solid fa-pen-to-square"></i>
                    </button>
                    <button class="btn crud-btns delete-Medicine" data-med-name="{{$medicines_list->name}}"
                            value="{{$medicines_list->id}}">
