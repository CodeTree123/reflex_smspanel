<div class="info-box-patient-col mb-3 pb-1">
    ...
    <div class="p-2 mx-2">
        <div class="row">
            ...
            <div class="col-12 text-start text-capitalize"><span class="fw-bolder">Helpatics</span> : <?php echo e($patient->Helpatics); ?></div>
    ...
    <div class="accordion accordion-flush" id="accordionFlushExample">
        <div class="accordion-item">
            ...
            <div id="flush-collapseOne<?php echo e($key +1); ?>" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                <div class="accordion-body">
                    <ul class="mb-2">
                        <li><span>Steps:</span><br> <?php echo e($t->steps); ?></li>
                    </ul>
...
<div class="info-box-col p-2 mb-3 text-center">
    <h4 class="d-flex justify-content-center bg-blue-grey custom-border-radius">Post to Furums</h4>
    <?php if($treatment_info->status == 2): ?>
    <a href="<?php echo e(route('case_studies',[$doctor_info->id,$patient->id,$treatment_info->id])); ?>" class="btn btn-outline-blue-grey my-3 btn-sm rounded">Click Here To Post</a>
    <?php else: ?>
    <button type="button" class="btn btn-outline-blue-grey my-3 btn-sm rounded" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="bottom" data-bs-content="Only Post When The Treatment Is Done!">
        Click Here To Post
    </button>
    <?php endif; ?>
</div>
...
<!-- Modal end -->
<?php endif; ?><?php /**PATH C:\xampp\htdocs\resources\views/doctor/include/patientRightSide.blade.php ENDPATH**/ ?>