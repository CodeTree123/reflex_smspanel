...
<body>
<?php echo $__env->make('admin.include.adminheader', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<div class="b-hor-example-divider"></div>

<div class="d-flex">
    <?php echo $__env->make('admin.other.include.admin_other_manu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <div class="mx-4 mt-3 w-100">
        <?php echo $__env->yieldContent('content'); ?>
    </div>
</div>

<?php echo $__env->yieldContent('page-modals'); ?>
...
<?php /**PATH /home1/reflexdn/public_html/resources/views/admin/other/admin_other_master.blade.php ENDPATH**/ ?>