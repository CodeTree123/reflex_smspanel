...
<div class="blank-sec p-0">
    <div class="row align-items-center p-3">
        ...
        <div class="col-7">
            <input type="text" name="" class="form-control" id="add_article_field" placeholder="Let's Share Your Articles" readonly>
        </div>
        <div class="col-3 text-center">
            <button type="button" class="btn btn-orange" data-bs-toggle="modal" data-bs-target="#CreatePostModal">Create Article</button>
        </div>
    </div>
</div>
...
<div class="modal fade" id="CreatePostModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('add_article')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-8 mb-3">
                            ...
                            <span class="text-danger"><?php $__errorArgs = ['postTitle'];
...
unset($__errorArgs, $__bag); ?></span>
                        ...
                        <div class="col-4 mb-3">
                            ...
                            <span class="text-danger"><?php $__errorArgs = ['article_image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></span>
                    ...
                    <div class="mb-3">
                        ...
                        <span class="text-danger"><?php $__errorArgs = ['summery'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php unset($message);
...
<script>
    $(document).ready(function() {
        ...
        <?php if(Session::has('invalidArticalAdd') && count($errors) > 0): ?>
        ...
        $(document).on('click', '#add_article_field', function() {
            $('#CreatePostModal').modal('show');
        });
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('forum.forum_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/reflexdn/public_html/resources/views/forum/layouts/articles.blade.php ENDPATH**/ ?>