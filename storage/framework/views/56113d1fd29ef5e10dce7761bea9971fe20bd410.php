                            ...
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseOne<?php echo e($key +1); ?>" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body">
                                        <ul class="mb-2">
                                            <li><span>Steps:</span><br> <?php echo nl2br(htmlentities($t->steps)); ?></li>
                                        </ul>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('master.doc_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/reflexdn/public_html/resources/views/doctor/treatmentplans.blade.php ENDPATH**/ ?>