<div class="profile blue-grey-border-thin">
    ...
    <div class="">
        <div class=" p-2 ms-1">
            ...
            <a href="<?php echo e(route('forum')); ?>" class="d-flex align-items-center p-3 ps-0 left-one-box-first rounded">
            ...
            <a href="<?php echo e(route('forum_populerPost_list')); ?>" class="d-flex align-items-center p-3 ps-0 left-one-box-second rounded">
                <div class="me-1 p-2 border rounded  ">
            ...
            <a href="<?php echo e(route('forum_favPost_list')); ?>" class="d-flex align-items-center p-3 ps-0 left-one-box-third rounded">
                <div class="me-1 p-2 border rounded  ">
                ...
                ?>
                <p class="badge bg-orange"><?php echo e($fav_count); ?></p>
            </a>
...
<div class="profile blue-grey-border-thin py-2">
    ...
    <div class=" left-second-box">
        ...
        <a href="<?php echo e(route('forum_case_studies')); ?>" class="d-flex   align-items-center my-1 p-2">
        ...
        <a href="<?php echo e(route('forum_article')); ?>" class="d-flex   align-items-center my-1 p-2">
        ...
        <a href="<?php echo e(route('forum_product_review')); ?>" class="d-flex   align-items-center my-1 p-2">
        ...
        <a href="<?php echo e(route('viewTutorial')); ?>" class="d-flex   align-items-center my-1 p-2">
            <div class="mx-1 bg-low-orange rounded side_icon_size2">
...
<?php /**PATH /home1/reflexdn/public_html/resources/views/forum/include/forumLeft.blade.php ENDPATH**/ ?>