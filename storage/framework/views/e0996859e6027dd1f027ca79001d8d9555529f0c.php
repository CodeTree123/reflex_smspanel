            ...
            <div class="col-12 mb-auto">
                <div class="d-flex justify-content-between">
                    ...
                    <div class="d-flex">
                        ...
                        <?php endif; ?>
                        <!-- <button class="btn bg-light-grey p-2 rounded-circle text-center mt-1 favourite_icon ms-2 social_btn">
                ...
                <div class="row align-items-center">
                    <div class="col-12">
                        <div class="row ">
                            <div class="col-3 d-flex <?php echo e($post->post_type == 4 ? 'justify-content-evenly':'justify-content-center'); ?> align-items-center p-2">
                    ...
                    <div class="col-12 mt-2">
                        <div class="d-flex justify-content-end align-items-center">
                            ...
                            <?php endif; ?>
                            <a href="<?php echo e(route('post_view',$post->id."#comments_section")); ?>" class="m-0 d-flex  align-items-center btn btn-sm ms-3">
...
<?php echo $__env->make('forum.forum_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home1/reflexdn/public_html/resources/views/forum/layouts/forum.blade.php ENDPATH**/ ?>