<div class="profile blue-grey-border-thin   ">
    ...
    <div class="complete">
        ...
        <div class="Patient-personal-info">
            <div class="row">
                <div class="col-12 text-start"><span class="fw-bolder">Patient ID: </span><?php echo e($patient->patient_id); ?></div>
                <div class="col-12 text-start"><span class="fw-bolder">Age: </span><?php echo e($patient->age); ?></div>
                <div class="col-12 text-start "><span class="fw-bolder">Gender: </span><?php echo e($patient->gender); ?></div>
                <div class="col-12 text-start "><span class="fw-bolder">Blood Group: </span><?php echo e($patient->Blood_group); ?></div>
                <div class="col-12 text-start"><span class="fw-bolder">DOB: </span><?php echo e($patient->date); ?></div>


                <div class="col-12 text-start"><span class="fw-bolder">Mobile: </span><?php echo e($patient->mobile); ?></div>
                <div class="col-12 text-start"><span class="fw-bolder">Mobile Type: </span><?php echo e($patient->m_type->name); ?></div>

                <div class="col-12 text-start"><span class="fw-bolder">Occupation: </span><?php echo e($patient->occupation); ?></div>
                <div class="col-12 text-start"><span class="fw-bolder">Address: </span><?php echo e($patient->address); ?></div>
                <div class="col-12 text-start"><span class="fw-bolder">Email: </span><?php echo e($patient->email); ?></div>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\resources\views/doctor/include/patientLeftSide.blade.php ENDPATH**/ ?>