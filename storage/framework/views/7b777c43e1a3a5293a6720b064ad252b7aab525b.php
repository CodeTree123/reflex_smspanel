...
unset($__errorArgs, $__bag); ?></span>
                            <div class="col-md-5 blue-grey-border py-4">
                                ...
                                <form action="<?php echo e(route('doctor')); ?>" method="GET">
                                    ...
                                    <div class="d-flex my-auto">
                                        <input class="form-control me-2 custom-form-control blue-grey-border-thin "
                                               type="text" placeholder="Search Old Patient"
                                               aria-label="default input example" name="search">
                                        <button type="submit"
                                                class="btn btn-outline-blue-grey" <?php echo e(auth()->user()->setting_alert == 1 ? 'disabled':''); ?>>
                                            Search
                                        </button>
                                    </div>
                                </form>
                            ...
                            <div class="col-md-5 blue-grey-border ">
                                ...
                                <div class="new-gen-pat">
                                    <!--  a tag trigger modal -->
                                    <button class="btn btn-outline-blue-grey text-white my-3" data-bs-toggle="modal"
                                            data-bs-target="#patitentAdd" <?php echo e(auth()->user()->setting_alert == 1 ? 'disabled':''); ?>>
                        ...
                        <?php if($p_search != 'null'): ?>
                            <div class="mx-3">
                                <table class="table table-bordered mt-4 text-center align-middle">
                                    ...
                                    <span>
                                        <a class="btn btn-sm crud-btns my-0"
                                           href="<?php echo e(route('view_patient',[$doctor_info->id,$pf->id])); ?>"
                                           data-bs-toggle="tooltip" data-bs-placement="top" title="View Patient Info">
                                            <i class="fa-solid fa-file-lines"></i>
                                                ...
                                                <span data-bs-toggle="modal"
                                                      data-bs-target="#patitentUpdate<?php echo e($pf->id); ?>">
                                        <button class="btn  btn-sm crud-btns" data-bs-toggle="tooltip"
                                                data-bs-placement="top" title="Update Patient Info">
                                        ...
                                        <button class="btn btn-sm crud-btns" data-bs-toggle="tooltip"
                                                data-bs-placement="top" title="Delete Patient Info">
                                        ...
                                        <div class="modal fade " id="patitentUpdate<?php echo e($pf->id); ?>" tabindex="-1"
                                            ...
                                            <div
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body pt-1 pb-0">
                                                        ...
                                                        <form
                                                            action="<?php echo e(route('edit.patient',[$doctor_info->id,$pf->id])); ?>"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-4">
                                                                    <div class="mb-2">
                                                                        <label for=" "
                                                                               class="form-label text-dark mb-1 d-flex justify-content-between">
                                                                            ID
                                                                        </label>
                                                                        <input type="number" name="patient_id"
                                                                               class="form-control"
                                                                               placeholder="Enter Patient ID"
                                                                               value="<?php echo e($pf->patient_id); ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="col-4">
                                                                    <div class="mb-2">
                                                                        <label for=" "
                                                                               class="form-label text-dark mb-1">Mobile
                                                                            no.</label>
                                                                        <input type="number" name="u_mobile"
                                                                               class="form-control custom-form-control"
                                                                               placeholder="Mobile No"
                                                                               value="<?php echo e($pf->mobile); ?>">
                                                                        <span
                                                                            class="text-danger"><?php $__errorArgs = ['u_mobile'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></span>
                                                                ...
                                                                <div class="col-4">
                                                                    <div class="mb-2">
                                                                        <label for="mName"
                                                                               class="form-label text-dark mb-1">Type</label>
                                                                        <select class="form-select" name="u_mobile_type"
                                                                            ...
                                                                            <?php $__currentLoopData = $mobile_type_lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mobile_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                <option
                                                                                    value="<?php echo e($mobile_type->id); ?>" <?php if($pf->mobile_type == $mobile_type->id): echo 'selected'; endif; ?>><?php echo e($mobile_type->name); ?></option>
                                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                        </select>
                                                                    </div>
                                                                    <span
                                                                        class="text-danger"><?php $__errorArgs = ['u_mobile_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></span>
                                                                ...
                                                                <div class="col-8">
                                                                    <div class="mb-2">
                                                                        <label for=" "
                                                                               class="form-label text-dark mb-1">Name</label>
                                                                        <input type="name" name="u_name"
                                                                               class="form-control custom-form-control"
                                                                               placeholder="Name" value="<?php echo e($pf->name); ?>">
                                                                        <span
                                                                            class="text-danger"><?php $__errorArgs = ['u_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></span>
                                                                ...
                                                                <div class="col-4">
                                                                    <div class="mb-2">
                                                                        <label for="mName"
                                                                               class="form-label text-dark mb-1">Date of
                                                                            Birth</label>
                                                                        <!-- <br> class="msform"-->
                                                                        <input
                                                                            class="form-control custom-form-control dob"
                                                                            name="u_date" type="date"
                                                                            value="<?php echo e($pf->date); ?>"
                                                                            max="<?php echo e(date('Y-m-d')); ?>">
                                                                        <span
                                                                            class="text-danger"><?php $__errorArgs = ['u_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></span>
                                                                ...
                                                                <div class="col-3">
                                                                    <div class="mb-2">
                                                                        <label for=" "
                                                                               class="form-label text-dark mb-1">Age</label>
                                                                        <input type="number" name="u_age"
                                                                               class="form-control custom-form-control age"
                                                                               id=" " aria-describedby="emailHelp"
                                                                               placeholder="Age" value="<?php echo e($pf->age); ?>"
                                                                               readonly>
                                                                        <span
                                                                            class="text-danger"><?php $__errorArgs = ['u_age'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></span>
                                                                ...
                                                                <div class="col-3">
                                                                    <div class="mb-2">
                                                                        <label for="mName"
                                                                               class="form-label text-dark mb-1">Gender</label>
                                                                        <select class="form-select" name="u_gender"
                                                                                aria-label="Gender">
                                                                            <option selected>Select gender</option>
                                                                            <option
                                                                                value="Male" <?php echo e($pf->gender == "Male" ? 'selected' : ''); ?>>
                                                                                Male
                                                                            </option>
                                                                            <option
                                                                                value="Female" <?php echo e($pf->gender == "Female" ? 'selected' : ''); ?>>
                                                                                Female
                                                                            </option>
                                                                            <option
                                                                                value="Other" <?php echo e($pf->gender == "Other" ? 'selected' : ''); ?>>
                                                                                Others
                                                                            </option>
                                                                        </select>
                                                                        <span
                                                                            class="text-danger"><?php $__errorArgs = ['u_gender'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></span>
                                                                ...
                                                                <div class="col-3">
                                                                    <div class="mb-2">
                                                                        <label for="mName"
                                                                               class="form-label text-dark mb-1">Blood
                                                                            Group</label>
                                                                        <select class="form-select" name="u_Blood_group"
                                                                                aria-label="Blood Group">
                                                                            <option selected> Patient's Blood Group
                                                                            </option>
                                                                            <option
                                                                                value="A+" <?php echo e($pf->Blood_group == "A+" ? 'selected' : ''); ?>>
                                                                                A+
                                                                            </option>
                                                                            <option
                                                                                value="A-" <?php echo e($pf->Blood_group == "A-" ? 'selected' : ''); ?>>
                                                                            ...
                                                                            <option
                                                                                value="B+" <?php echo e($pf->Blood_group == "B+" ? 'selected' : ''); ?>>
                                                                                B+
                                                                            </option>
                                                                            <option
                                                                                value="B-" <?php echo e($pf->Blood_group == "B-" ? 'selected' : ''); ?>>
                                                                            ...
                                                                            <option
                                                                                value="AB-" <?php echo e($pf->Blood_group == "AB+" ? 'selected' : ''); ?>>
                                                                                AB+
                                                                            </option>
                                                                            <option
                                                                                value="AB-" <?php echo e($pf->Blood_group == "AB-" ? 'selected' : ''); ?>>
                                                                            ...
                                                                            <option
                                                                                value="O+" <?php echo e($pf->Blood_group == "O+" ? 'selected' : ''); ?>>
                                                                                O+
                                                                            </option>
                                                                            <option
                                                                                value="O-" <?php echo e($pf->Blood_group == "O-" ? 'selected' : ''); ?>>
                                                                        ...
                                                                        <span
                                                                            class="text-danger"><?php $__errorArgs = ['u_Blood_group'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></span>
                                                                ...
                                                                <div class="col-3">
                                                                    <div class="mb-2">
                                                                        <label for=" "
                                                                               class="form-label text-dark mb-1">Occupation</label>
                                                                        <input type="text"
                                                                               class="form-control custom-form-control"
                                                                               name="u_occupation"
                                                                               placeholder="Occupation"
                                                                               value="<?php echo e($pf->occupation); ?>">
                                                                        <span
                                                                            class="text-danger"><?php $__errorArgs = ['u_occupation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></span>
                                                                ...
                                                                <div class="col-12 mb-2">
                                                                    ...
                                                                    <input type="address"
                                                                           class="form-control custom-form-control"
                                                                           name="u_address" placeholder="Address"
                                                                           value="<?php echo e($pf->address); ?>">
                                                                    <span
                                                                        class="text-danger"><?php $__errorArgs = ['u_address'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></span>
                                                                ...
                                                                <div class="col-12">
                                                                    ...
                                                                    <input type="email" name="u_email"
                                                                           ...
                                                                           value="<?php echo e($pf->email); ?>">
                                                                    <span
                                                                        class="text-danger"><?php $__errorArgs = ['u_email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php unset($message);
...
unset($__errorArgs, $__bag); ?></span>
                                                                ...
                                                                <div class="col-6 mt-2">
                                                                    <label for="formFile" name="image"
                                                                           class="form-label text-dark mb-1">Drop your
                                                                        image</label>
                                        ...
                                        <div class="Appointment-details blue-grey-border-thin    p-2">
                                            <div class="d-flex align-items-center">
                                                <div class="Appointment-Patient-img me-2">
                                                    ...
                                                    <?php else: ?>
                                                        <img
                                                            src="<?php echo e(url('public/uploads/patient/'.$appointment->image)); ?>">
                                                    <?php endif; ?>
                                                </div>
                                                <div class="patient-status m-auto my-1">
                                                    <a class="btn btn-sm btn-outline-blue-grey m-0"
                                                       href="<?php echo e(route('view_patient',[$appointment->d_id,$appointment->p_id])); ?>"
                                                       role="button">View</a>
                                                </div>
                                            </div>
                    ...
                    <?php else: ?>
                        ...
                        <div class="greetings-sec m-3 p-3 blue-grey-border">
                            ...
                            <p class="">
                                ...
                                anywhere using only a browser and Internet connection. <span
                                    class="fw-bold">ReflexDN</span>'s brilliantly designed interface makes it easy for
                                ...
                                spend time on what matters most - <span
                                    class="fw-bold">taking care of their patients.</span>
                                <br><br>
            ...
            <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="<?php echo e(route('patient_info',[$doctor_info->id])); ?>" method="POST"
                                ...
                                <div class="col-4">
                                    <div class="mb-2">
                                        ...
                                        <input type="number" name="patient_id" class="form-control"
                                               placeholder="Enter Patient ID" value="<?php echo e(old('patient_id')); ?>">
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="mb-2">
                                        ...
                                        <input type="number" name="mobile" class="form-control"
                                               placeholder="Enter Mobile No" value="<?php echo e(old('mobile')); ?>">
                                ...
                                <div class="col-4">
                                    <div class="mb-2">
                                        ...
                                        <select class="form-select" name="mobile_type" aria-label="Mobile Type">
                                            <?php $__currentLoopData = $mobile_type_lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mobile_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option
                                                    value="<?php echo e($mobile_type->id); ?>" <?php if(old('mobile_type')==$mobile_type->id): echo 'selected'; endif; ?>><?php echo e($mobile_type->name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
...
unset($__errorArgs, $__bag); ?></span>
                                ...
                                <div class="col-4">
                                    <div class="mb-2">
                                        ...
                                        <input class="form-control dob" name="date" type="date" value="<?php echo e(old('date')); ?>"
                                               max="<?php echo e(date('Y-m-d')); ?>">
...
unset($__errorArgs, $__bag); ?></span>
                                ...
                                <div class="col-3">
                                    <div class="mb-2">
                                        ...
                                        <input type="number" name="age" class="form-control age" id=""
                                               aria-describedby="emailHelp" placeholder="Age" value="<?php echo e(old('age')); ?>"
                                               readonly>
                                ...
                                <div class="col-3">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control" name="occupation"
                                               placeholder="Occupation" value="<?php echo e(old('occupation')); ?>">
...
unset($__errorArgs, $__bag); ?></span>
                                ...
                                <div class="col-12 mb-2">
                                    ...
                                    <input type="address" class="form-control" name="address"
                                           placeholder="Enter Address" value="<?php echo e(old('address')); ?>">
...
unset($__errorArgs, $__bag); ?></span>
        ...
        <div class="modal fade " id="patitentDelete" tabindex="-1" aria-labelledby="exampleModalLabel"
             aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered">
                <div class="modal-content">
                    <!-- Modal Header & Close btn -->
                            ...
                            <?php $__currentLoopData = $p_search; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <form action="<?php echo e(route('delete.patient',[$doctor_info->id,$pf->id])); ?>" method="POST">
                                    ...
                                    <div class="mb-3 text-center">
                                        <h5 class="text-danger">Are You Sure to Delete <span
                                                class="text-dark"><?php echo e($pf->name); ?></span> Information</h5>
                                    </div>
...
<?php echo $__env->make('master.doc_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\resources\views/doctor/doctor.blade.php ENDPATH**/ ?>